        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.id}>
              ...
              <CustomTableCell {...{ row, name: "numberOfStaff", onChange }} />
              <CustomTableCell
                {...{ row, name: "fTAcademicStaff", onChange }}
              />
              <CustomTableCell
                {...{ row, name: "pTAcademicStaff", onChange }}
              />
              <CustomTableCell {...{ row, name: "SSR", onChange }} />
            </TableRow>
          ))}
        </TableBody>
      </Table>
